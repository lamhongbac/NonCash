...
namespace NonCash.Infrastructure.Migrations
{
    ...
    [Migration("20260623030118_AddVoucherTransfers")]
    partial class AddVoucherTransfers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NonCash.Core.Entities.VoucherTransfer", b =>
                {
                    b.HasOne("NonCash.Core.Entities.Customer", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NonCash.Core.Entities.Customer", "Sender")
                        .WithMany()
